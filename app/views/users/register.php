      ...
      <div class="card card-body bg-light mt-5">
        ...
        <form action="<?php echo URLROOT;?>/users/register" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" id="email" class="form-control <?php echo (!empty($data['email_err'])) ?
              'is-invalid' : ''; ?>" name="email">
            <span class="invalid-feedback"><?php echo $data['email_err'];?></span>
          </div>
          <div class="form-group">
            <label for="pass">Password: <sup>*</sup></label>
            <input type="password" id="pass" class="form-control <?php echo (!empty($data['pass_err'])) ?
              'is-invalid' : ''; ?>"  name="pass">
            <span class="invalid-feedback"><?php echo $data['pass_err'];?></span>
          </div>
          <div class="form-group">
            <label for="pass2">Confirm password: <sup>*</sup></label>
            <input type="password" id="pass2" class="form-control <?php echo (!empty
            ($data['pass2_err'])) ? 'is-invalid' : ''; ?>" name="pass2">
